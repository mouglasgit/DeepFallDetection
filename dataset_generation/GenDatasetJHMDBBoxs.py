...
path_dataset = '/media/oberon/MouglasHD2T/actions_datasets/JHMDB/JHMDB_video/ReCompress_Videos/'
path_puppet_files = "/media/oberon/MouglasHD2T/actions_datasets/JHMDB/puppet_flow_ann/"

save_dataset = '/media/oberon/MouglasHD2T/actions_datasets/JHMDB/process_jhmdb_boxs/'
...
def load_annotations(path_puppet):
    masks = sio.loadmat(path_puppet)['part_mask']    
    depth = masks.shape[2]
    boxs = []
...
for act_dir in action_dirs:
    ...
    for video_name in video_files:
        ...
        if frames_count >= window_size:
            ...
            path_mat = "{}{}/{}/{}".format(path_puppet_files, act_dir, video_name[:-4], "puppet_flow.mat")
